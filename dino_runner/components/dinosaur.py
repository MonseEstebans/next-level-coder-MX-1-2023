...
class Dinosaur(Sprite):
    ...
    def jump(self):
        ...
        if self.dino_jump:
            self.dino_rect.y -= self.jump_vel * 5 # Salto
    ...
    def check_invincibility(self):
         if self.shield:
             time_to_show = round((self.shield_time_up - pygame.time.get_ticks()) / 1000, 2)#redondea para saber si hay tiempo para mostrar
